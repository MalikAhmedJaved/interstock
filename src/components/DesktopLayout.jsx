...
const DesktopLayout = ({ children, activePath }) => {
  ...
  return (
    <div className="flex min-h-screen bg-background-light">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        {/* Top Header */}
        <header
          className="sticky top-0 z-10 flex items-center justify-between px-4 sm:px-6 lg:px-8 py-4 sm:py-6 backdrop-blur-md bg-background-light/80"
          style={{ boxShadow: '0 0 14px rgba(0,0,0,0.1)' }}
        >
          {/* Mobile hamburger */}
          <button
